export const doctors = [
  { id_doctor: 1, name: "Dr. Obi-Wan Kenobi", specialty: "Cardiologia", icon: "F" },
  { id_doctor: 2, name: "Dr. Darth Vader", specialty: "Cirurgia Torácica", icon: "M" },
  { id_doctor: 3, name: "Dr. Yoda", specialty: "Neurologia", icon: "M" },
  { id_doctor: 4, name: "Dr. Luke Skywalker", specialty: "Ortopedia", icon: "F" },
  { id_doctor: 5, name: "Dr. Anakin Skywalker", specialty: "Pediatria", icon: "M" },
  { id_doctor: 6, name: "Dr. Qui-Gon Jinn", specialty: "Dermatologia", icon: "F" },
  { id_doctor: 7, name: "Dr. Mace Windu", specialty: "Oftalmologia", icon: "M" },
  { id_doctor: 8, name: "Dr. Palpatine", specialty: "Psiquiatria", icon: "M" },
  { id_doctor: 9, name: "Dr. Boba Fett", specialty: "Cirurgia Plástica", icon: "F" },
  { id_doctor: 10, name: "Dr. Kylo Ren", specialty: "Endocrinologia", icon: "F" }
];

export const doctors_services = [
  { id_service: 1, description: "Consulta de Cardiologia", price: 500 },
  { id_service: 2, description: "Cirurgia Torácica", price: 15000 },
  { id_service: 3, description: "Avaliação Neurológica", price: 800 },
  { id_service: 4, description: "Consulta Ortopédica", price: 600 },
  { id_service: 5, description: "Consulta Pediátrica", price: 400 },
  { id_service: 6, description: "Consulta Dermatológica", price: 500 },
  { id_service: 7, description: "Exame Oftalmológico", price: 300 },
  { id_service: 8, description: "Consulta Psiquiátrica", price: 700 },
  { id_service: 9, description: "Consulta Cirurgia Plástica", price: 1000 },
  { id_service: 10, description: "Consulta Endocrinológica", price: 600 }
];
